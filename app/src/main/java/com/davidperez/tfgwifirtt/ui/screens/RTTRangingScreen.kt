...
fun RTTRangingScreen(
    ...
    RTTResults(
        ...
        onStartRTTRanging = { selectedForRTT, performContinuousRttRanging, rttPeriod, rttInterval, saveRttResults, saveOnlyLastRttOperation, ignoreRttPeriod -> accessPointsViewModel.startRTTRanging(selectedForRTT, performContinuousRttRanging, rttPeriod, rttInterval, saveRttResults, saveOnlyLastRttOperation, ignoreRttPeriod) },
        ...
        isRTTRangingOngoing = accessPointsUiState.isRTTRangingOngoing
    )
...
fun RTTResults(
    ...
    onStartRTTRanging: (List<AccessPoint>, Boolean, Long, Long, Boolean, Boolean, Boolean) -> Unit,
    onExportRTTRangingResultsToCsv: (List<RangingResultWithTimestamps>) -> String,
    userSettings: UserSettings,
    isRTTRangingOngoing: Boolean,
    ...
    LazyColumn {
        ...
        item {
            Row(
                ...
                OutlinedButton(
                    onClick = { onStartRTTRanging(selectedForRTT, userSettings.performContinuousRttRanging, userSettings.rttPeriod * 1000, userSettings.rttInterval, userSettings.saveRttResults, userSettings.saveOnlyLastRttOperation, userSettings.ignoreRttPeriod) },
                    enabled = !isRTTRangingOngoing,
                ...
                // TODO: add stop RTT Ranging button

//                OutlinedButton(
//                    onClick = {
//                        onStopRTTRanging()
//                        isRTTRangingOngoing = false },
//                    enabled = isRTTRangingOngoing,
//                    modifier = modifier.padding(5.dp).fillMaxSize()
//                ) {
//                    Text(
